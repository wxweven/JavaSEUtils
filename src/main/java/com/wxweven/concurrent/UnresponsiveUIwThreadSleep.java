...
public class UnresponsiveUIwThreadSleep extends JFrame {
    ...
    public UnresponsiveUIwThreadSleep() {
        ...
        btnStart.addActionListener(evt -> {
            ...
            Thread t = new Thread(() -> { // override the run() for the running
                // behaviors
        ...
        cp.add(btnStop);
        btnStop.addActionListener(evt -> stop = true);
    ...
    public static void main(String[] args) {
        ...
        // Let the constructor do the
        javax.swing.SwingUtilities.invokeLater(UnresponsiveUIwThreadSleep::new);
    }
}